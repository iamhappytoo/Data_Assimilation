...
output_root_dir='C:/Users/BANZH/Downloads/2019spring/CEE Steve/Project_outputs/true_output_1day/';
...
tsQ=nan(1,1464);
tsSrz=nan(1,1465);
mapSD=nan(26,19,1464,1);
mapET=nan(26,19,1464,1);
mapSrz=nan(26,19,1464,1);
...
oltsQ=load('C:/Users/BANZH/Downloads/2019spring/CEE steve/Project_outputs/open_loop_ensemble/tsQ.mat','tsQ');
oltsET=load('C:/Users/BANZH/Downloads/2019spring/CEE steve/Project_outputs/open_loop_ensemble/tsET.mat','tsET');
oltsSD=load('C:/Users/BANZH/Downloads/2019spring/CEE steve/Project_outputs/open_loop_ensemble/tsSD.mat','tsSD');
olmapET=load('C:/Users/BANZH/Downloads/2019spring/CEE steve/Project_outputs/open_loop_ensemble/mapET.mat','mapET');
olmapSD=load('C:/Users/BANZH/Downloads/2019spring/CEE steve/Project_outputs/open_loop_ensemble/mapSD.mat','mapSD');
olmapSrz=load('C:/Users/BANZH/Downloads/2019spring/CEE steve/Project_outputs/open_loop_ensemble/mapSrz.mat','mapSrz');
oltsSrz=load('C:/Users/BANZH/Downloads/2019spring/CEE steve/Project_outputs/open_loop_ensemble/tsSrz.mat','tsSrz');

%% Plot truth realization together with open loop ensembles of realizations
DOY=183:1:243;
figure(1);hold on
plot(DOY,mean(reshape(states.time_series.SD(2:1465),24,61)),'k','LineWidth',3)
for i=1:20
    figure(1);hold on
    plot(DOY,mean(reshape(squeeze(oltsSD.tsSD(i,2:1465)),24,61)),'c');
end
        xlabel('DOWY');ylabel('SD (m)')
        set(gca,'FontSize',18,'YDir','normal');grid;
        legend('Truth','Ensemble','Location','south')
figure(2);hold on
plot(DOY,mean(reshape(states.time_series.Srz(2:1465),24,61)),'k','LineWidth',3)
for i=1:20
    figure(2);hold on
    plot(DOY,mean(reshape(squeeze(oltsSrz.tsSrz(i,2:1465)),24,61)),'c');
end
...
figure(3);hold on
plot(DOY,mean(reshape(fluxes.time_series.ET,24,61)),'k','LineWidth',3)
for i=1:20
    figure(3);hold on
    plot(DOY,mean(reshape(squeeze(oltsET.tsET(i,:)),24,61)),'c');
end
...
figure(4);hold on
plot(DOY,mean(reshape(tsQ,24,61)),'k','LineWidth',3)
for i=1:20
    figure(4);hold on
    plot(DOY,mean(reshape(squeeze(oltsQ.tsQ(i,:)),24,61)),'c');
end
...
figure(5);hold on
plot(DOY,ZMEAS(1,:),'r','Linewidth',2);
figure(6);hold on
plot(DOY,ZMEAS(2,:),'b','Linewidth',2);
figure(7);hold on
plot(DOY,ZMEAS(3,:),'c','Linewidth',2);
figure(8);hold on
plot(DOY,ZMEAS(4,:),'g','Linewidth',2);
figure(9);hold on
plot(DOY,ZMEAS(5,:),'m','Linewidth',2);
%plot truth SD at 5 locations
    figure(5);hold on
    plot(DOY,squeeze(states.maps.SD(19,3,24:24:1440)),'k','Linewidth',1.5);
    figure(6);hold on
    plot(DOY,squeeze(states.maps.SD(15,8,24:24:1440)),'k','Linewidth',1.5);
    figure(7);hold on
    plot(DOY,squeeze(states.maps.SD(8,10,24:24:1440)),'k','Linewidth',1.5);
    figure(8);hold on
    plot(DOY,squeeze(states.maps.SD(12,16,24:24:1440)),'k','Linewidth',1.5);
    figure(9);hold on
    plot(DOY,squeeze(states.maps.SD(14,17,24:24:1440)),'k','Linewidth',1.5);
    %plot open loop ensemble at 5 locations
for i=1:20
    figure(5);hold on
    plot(DOY,squeeze(olmapSD.mapSD(19,3,24:24:1440,i)),'.r');
    figure(6);hold on
    plot(DOY,squeeze(olmapSD.mapSD(15,8,24:24:1440,i)),'.b');
    figure(7);hold on
    plot(DOY,squeeze(olmapSD.mapSD(8,10,24:24:1440,i)),'.c');
    figure(8);hold on
    plot(DOY,squeeze(olmapSD.mapSD(12,16,24:24:1440,i)),'.g');
    figure(9);hold on
    plot(DOY,squeeze(olmapSD.mapSD(14,17,24:24:1440,i)),'.m');
end
    figure(5);hold on
    xlabel('DOWY');ylabel('SD (m)')
    set(gca,'FontSize',18,'YDir','normal');grid;
    ...
    cd('C:\Users\BANZH\Downloads\2019spring\CEE Steve\Project_outputs\true_output_1day\');
    mkdir('C:\Users\BANZH\Downloads\2019spring\CEE Steve\Project_outputs\true_output_1day\Figures');
