...
output_root_dir='C:/Users/BANZH/Downloads/2019spring/CEE Steve/Project_outputs/true_output/';
%% --------- SPECIFY INPUTS HERE ----------------------------------------%%
...
for i=1:20
    figure(4);hold on
    plot(DOY,mean(reshape(squeeze(tsQ(i,:)),24,61)),'c');
end
