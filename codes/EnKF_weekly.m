...
output_root_dir='C:/Users/BANZH/Downloads/2019spring/CEE Steve/Project_outputs/enkf_output_weekly_0.1/';
...
measurement_input_file='C:/Users/BANZH/Downloads/2019spring/CEE Steve/Project_outputs/true_output_weekly_0.1/measurements.mat';
...
load('C:/Users/BANZH/Downloads/2019spring/CEE Steve/Project_outputs/enkf_output_weekly_0.1/merged_EnKF_outputs.mat');
EnsSD=nan(26,19,1464,20);
EnsSrz=nan(26,19,1464,20);
EnsET=nan(26,19,1464,20);
EnsQ=nan(1464,20);
EnsSD=STATE_maps.SD;
...
load('C:/Users/BANZH/Downloads/2019spring/CEE Steve/Project_outputs/true_output_weekly_0.1/measurements.mat');
load('C:/Users/BANZH/Downloads/2019spring/CEE steve/Project_outputs/true_output_weekly_0.1/true_output.mat');
Srz2=(EnsSrz).^2;
SD2=(EnsSD).^2;
ET2=(EnsET).^2;
Q2=(EnsQ).^2;
Srz_stddev=sqrt(mean(Srz2,4)-MeanEnsSrz.^2);
...
figure(4)
plot(DOY,squeeze(states.maps.SD(row0,col0,:)),'b','LineWidth',3);hold on
...
title(['Time series and measurements for pixel: (' num2str(15) ',' num2str(15) ')'])
set(gca,'FontSize',14);grid
legend('True','EnKF Ens. Mean','+3 Std. Dev.','-3 Std. Dev.','Ens')

cd('C:\Users\BANZH\Downloads\2019spring\CEE Steve\Project_outputs\enkf_output_weekly_0.1\');
mkdir('C:\Users\BANZH\Downloads\2019spring\CEE Steve\Project_outputs\enkf_output_weekly_0.1\Figures');
