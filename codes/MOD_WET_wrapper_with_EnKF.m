...
toolbox_path='/Users/margulis/Box Sync/CEE251D/MOD_WET_2017a/MOD_WET_src';
% Add path
addpath(genpath(toolbox_path))

% Specify root directory where to store outputs
output_root_dir='/Users/margulis/Box Sync/CEE251D/MOD_WET_outputs/low_elev_basin/DA_outputs/';
...
measurement_input_file='/Users/margulis/Box Sync/CEE251D/MOD_WET_outputs/low_elev_basin/DA_outputs/measurements.mat';
...
output_state_maps(1).names='Srz';output_state_maps(2).names='SD';
...
output_flux_maps(1).names='Rn';output_flux_maps(2).names='LE';
...
single_output_file_flag=0; % 0=ensemble-wise files; 1= one single file. 
