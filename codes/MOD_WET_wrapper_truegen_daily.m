...
output_root_dir='C:/Users/BANZH/Downloads/2019spring/CEE Steve/Project_outputs/long_true_output_daily_0.1/';
...
for i_ensemble=1:N_ensemble_members
    ...
    % Replace output fiNNlename with one specific to this ensemble member
...
%plot truth SD at 5 locations
    figure(5);hold on
    plot(DOY,squeeze(states.maps.SD(19,3,24:24:5808)),'k','Linewidth',1.5);
    figure(6);hold on
    plot(DOY,squeeze(states.maps.SD(15,8,24:24:5808)),'k','Linewidth',1.5);
    figure(7);hold on
    plot(DOY,squeeze(states.maps.SD(8,10,24:24:5808)),'k','Linewidth',1.5);
    figure(8);hold on
    plot(DOY,squeeze(states.maps.SD(12,16,24:24:5808)),'k','Linewidth',1.5);
    figure(9);hold on
    plot(DOY,squeeze(states.maps.SD(14,17,24:24:5808)),'k','Linewidth',1.5);
    %plot open loop ensemble at 5 locations
for i=1:20
    figure(5);hold on
    plot(DOY,squeeze(olmapSD.mapSD(19,3,24:24:5808,i)),'--r');
    figure(6);hold on
    plot(DOY,squeeze(olmapSD.mapSD(15,8,24:24:5808,i)),'--b');
    figure(7);hold on
    plot(DOY,squeeze(olmapSD.mapSD(8,10,24:24:5808,i)),'--c');
    figure(8);hold on
    plot(DOY,squeeze(olmapSD.mapSD(12,16,24:24:5808,i)),'--g');
    figure(9);hold on
    plot(DOY,squeeze(olmapSD.mapSD(14,17,24:24:5808,i)),'--m');
end
    figure(5);hold on
    xlabel('DOWY');ylabel('SD (m)')
    set(gca,'FontSize',18,'YDir','normal');grid;
    ...
    cd('C:\Users\BANZH\Downloads\2019spring\CEE Steve\Project_outputs\long_true_output_daily_0.1\');
    mkdir('C:\Users\BANZH\Downloads\2019spring\CEE Steve\Project_outputs\long_true_output_daily_0.1\Figures');
    saveas(figure(1),[pwd '/Figures/truth_basin_avg_SD.png']);        
    saveas(figure(2),[pwd '/Figures/truth_basin_avg_Srz.png']);        
    saveas(figure(3),[pwd '/Figures/truth_basin_avg_ET.png']);        
    saveas(figure(4),[pwd '/Figures/truth_basin_avg_Q.png']);        
