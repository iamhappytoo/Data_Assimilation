...
for i_ensemble=1:N_ensemble_members
    ...
    % Perturb T0 field
    restart_info.params.K0=multiplicative_factor(:,:,1).*restart_info.params.K0;
...
save('C:/Users/zban/Downloads/2019 spring quarter/CEE Steve/Project_outputs/open_loop_ensemble/pos_K0_0_d_rz/tsSrz.mat','tsSrz')
DOY=213:1:243;
figure(1);hold on
